...
const routeData = {
  ...
  day3: [
    ...
    { lat: 33.5352, lng: 126.6080, name: '카페 점점 🌽', desc: '15:20 조천읍 신촌리 오션뷰 카페, 달콤한 초당옥수수 디저트' },
...
const foodData = [
  ...
  },
  {
    ...
    emoji: '🌽',
    rating: 4.7,
    desc: '함덕에서 공항으로 가는 해안도로변 오션뷰 감성 카페. 2층 통창 너머의 노을이 아름다우며, 고소하고 달콤한 초당옥수수 아이스크림 디저트가 대유행인 핫플레이스.',
    menu: '초당옥수수 아이스크림, 초당옥수수 라떼, 한라산 약과',
    price: '6,500원 ~ 16,000원',
    mapUrl: 'https://map.naver.com/v5/search/조천읍%20점점'
  },
  {
    id: 'food_4',
    name: '보목해녀의집 (서귀포 보목동)',
